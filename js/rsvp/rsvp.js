    ...
    this.submit(function (event) {
      ...
      $.each(ajax_input_element , function(index, element){
        ...
        if ($(this).hasClass("ajax-checkbox")) {
          ...
          var checked_checkbox = $("#" + element.id + ":checked");
          ...
          if (checked_checkbox.length > 0 || !($(this).attr("data-required")) ) {
            ...
            if (element.getAttribute("data-output-label")) {
        ...
        // ELSE IF CHECKED CHECKBOX GUEST
        else if ($(this).hasClass("ajax-checkbox-guest")) {
          ...
          if ($(this)[0].checked) {
            ...
            if (checked_checkbox.length > 0 || !($(this).attr("data-required")) ) {
              $(this).removeClass("has-error");
              post_data.secondary.push(checked_checkbox.map(function(i, elem) { return $(this).val(); }).get().join( ", " ));
            }
            else {
              $(this).addClass("has-error");
              all_err.push(element.getAttribute("data-required"));
        ...
        // ELSE IF SELECT
        else if ($(this).hasClass("ajax-select")) {
          ...
          if ( this_input_value == null  || this_input_value.length == 0 ) {
            ...
            post_data[element.id] = $(this).find(":selected").text();
          }
        }
